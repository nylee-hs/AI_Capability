...
def main():
    ...
    # model = Doc2Vec(corpus, dm=0, dbow_words=1, window=8, seed=1234, alpha=0.025, vector_size=850, min_count=1, min_alpha=0.025, workers=cores, hs=1, negative=10, epochs=10)
