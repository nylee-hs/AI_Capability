...
from doc2vec_input2 import Doc2VecInput
...
def main():
    ...
    model = Doc2VecModeler(tagged_doc=tagged_doc)

    #
    model = Doc2VecEvaluator(model.model_path+model.data_name+'_doc2vec.model')
